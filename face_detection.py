...
while True:
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            #argmin grabs the floor value from array (smallest distance and return the in)
    ...
    for(top, right, bottom, left), name in zip(face_locations, face_names):
        #Scale back up face locations since the frame we detected in was scaled down to 1/4th size
        top *= 4
        right *= 4
        bottom *= 4
        left *= 4
        ...
        #Draw a lavel with a name below the face
